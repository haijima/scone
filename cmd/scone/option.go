...
func SetQueryOptionFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringSlice("exclude-queries", []string{}, "The `hashes` of queries to exclude")
	...
	cmd.Flags().StringSlice("filter-queries", []string{}, "The `hashes` of queries to filter")
